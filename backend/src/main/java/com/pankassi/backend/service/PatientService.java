...
public class PatientService {
    ...
    public ClientResponse registerPatient (RegisterPatientRequest registerPatientRequest){
        ...
        Client newClient = authenticationService.registerClient(clientRequest);
